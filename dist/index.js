...
exports.humanize = __webpack_require__(854);
...
const ms_1 = __importDefault(__webpack_require__(761));
...
function init() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!GITHUB_TOKEN) {
            ...
            const minAge = ms_1.default(core.getInput('minAge', { required: true }));
            const maxDownloads = parseInt(core.getInput('maxDownloads'), 10) || 0;
            const packageType = core.getInput('packageType') || 'docker';
            yield action_1.runAction(GITHUB_TOKEN, { minAge, maxDownloads, repo, owner, packageType });
        }
    });
}
init();
