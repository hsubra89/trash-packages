...
exports.humanize = __nccwpck_require__(4697);
...
var debug = __nccwpck_require__(8237)("follow-redirects");
...
var ms_default = /*#__PURE__*/__nccwpck_require__.n(ms);
...
function runAction(githubToken, settings) {
    return __awaiter(this, void 0, void 0, function* () {
        const versions = yield runGraphQLQuery(githubToken, FETCH_PACKAGE_VERSIONS_QUERY, { repo: settings.repo, owner: settings.owner });
        ...
        const flattenedVersions = versions.data.repository.packages.nodes
            ...
            return Object.assign(Object.assign({}, packageNodes), { versions: Object.assign(Object.assign({}, packageNodes.versions), { nodes: versionNodes }) });
        });
        // Deleting packages
 ...
 */
function runGraphQLQuery(githubToken, query, variables) {
    return axios_default().post(`https://api.github.com/graphql`, {
        query,
...
function init() {
    return src_awaiter(this, void 0, void 0, function* () {
        ...
        if (!GITHUB_TOKEN) {
            ...
            const minAge = ms_default()(core.getInput('minAge', { required: true }));
            ...
            yield runAction(GITHUB_TOKEN, { minAge, maxDownloads, repo, owner, packageType });
        }
    });
}
init()
